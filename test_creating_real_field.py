...
def main():
    ...
    yRange = [field_y_length / 4, (field_y_length / 4) * 3], \
    zRange = [field_z_length - 6, field_z_length - 1], \
    rangeOfPollutionRadius = [40, 40], \
    ...
    pollution_state_drawer_3D.setCmap("cool")
    ...
    pollution_state_drawer_3D.setCmap("autumn")

    pollution_state_drawer_3D.setSizeOfPlotPoint(30)
    pollution_state_drawer_3D.draw_pollution_map(allPollutions[::-1], \
    concentration_limit_to_display = 25, xlim = field_x_length, \
    ylim = field_x_length, zlim = field_z_length)
